...
```
  ...
  > なぜここがフィードバック制御じゃないかというと, 単なる技術不足と怠慢です  
...
- mbed側がマスクしすぎて8個あるTIMのうち4個しか使えなかった. あとピンアサインの相談をじっくりしなかったせいで貴重なPWMのピンをただのDigitalOutに消費してしまった.
- 強い人たちの制御と見比べるとやっぱ技術的に見劣りする.  
